...
const AperturaEstiva = () => {
  ...
  const phases = [
    ...
    {
      id: 2,
      title: 'Rimozione e Pulizia Copertura',
      description: 'Rimozione, pulizia e riposizionamento della copertura invernale',
    ...
    },
    {
      ...
      description: 'Pulizia della piscina e preparazione degli impianti',
      icon: <Pool />,
      color: '#fa709a',
      duration: 5
    },
    {
      id: 4,
      title: 'Riempimento',
      description: 'Riempimento della piscina al livello corretto',
      icon: <WaterDrop />,
      color: '#fee140',
      duration: 8
    },
    {
      id: 5,
      title: 'Avvio Filtrazione',
      description: 'Avvio del sistema di filtrazione',
      icon: <Settings />,
      color: '#a8edea',
      duration: 3
    },
    {
      ...
      description: 'Aggiunta dei prodotti chimici calcolati',
      icon: <TrendingUp />,
      color: '#4caf50',
      duration: 6
    },
    {
      ...
      description: 'Verifica finale di tutti i parametri',
      icon: <CheckCircle />,
      color: '#ff9800',
      duration: 4
    }
  ...
  const calculateDosages = () => {
    ...
    let cloroShock = 0;
    if (cloro >= 0 && cloro < 3) {
      cloroShock = (4 - cloro) * 20 * volume / 1000; // 20 g/mq per 1 ppm, convertito in kg
    }
    ...
    if (ph > 0) {
      if (ph < 7.3) {
        // pH+ polvere: 3g per mc per aumentare di 0.1 unità
        const differenzaPh = 7.3 - ph;
        const unitaDaCorreggere = differenzaPh / 0.1; // quante unità di 0.1 devo correggere
        phPlus = unitaDaCorreggere * 3 * volume / 1000; // 3 g/mc per 0.1 unità, convertito in kg
      } else if (ph > 7.3) {
        // pH- polvere: 3g per mc per diminuire di 0.1 unità
        const differenzaPh = ph - 7.3;
        const unitaDaCorreggere = differenzaPh / 0.1; // quante unità di 0.1 devo correggere
        phMinus = unitaDaCorreggere * 3 * volume / 1000; // 3 g/mc per 0.1 unità, convertito in kg
      }
    }
  ...
  return (
    <Box sx={{ 
      ...
      <Container maxWidth="lg">
        ...
        >
          <BeachAccess sx={{ mr: 2, verticalAlign: 'middle' }} />
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} sm={6}>
                <Card sx={{ p: 2, textAlign: 'center', background: '#e8f5e8' }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Carbonato di sodio polvere (10g/mc per 0.1 punti)
                  </Typography>
                </Card>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Card sx={{ p: 2, textAlign: 'center', background: '#ffebee' }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Acido muriatico polvere (10g/mc per 0.1 punti)
                  </Typography>
                </Card>
              </Grid>
              <Grid item xs={12} sm={6}>
              ...
              {dosages.sequestrante > 0 && (
                <Grid item xs={12}>
                  <Card sx={{ p: 2, textAlign: 'center', background: '#f3e5f5' }}>
                    <Typography variant="h6" color="#7b1fa2" gutterBottom>
                      Sequestrante
                    </Typography>
                    <Typography variant="h4" sx={{ fontWeight: 'bold', color: '#7b1fa2' }}>
                      {dosages.sequestrante} kg
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                      Per acido cianurico elevato
                    </Typography>
                  </Card>
                </Grid>
              )}
